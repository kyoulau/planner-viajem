...
interface InviteGuestsModel {
    // Declara dentro dessa interface as variaveis que vai receber do componente pai
...
export function InviteGuestsModel({
  // desestruturação de cada elemento props para serem mandados para o pai
  closeGuestsModal,
  emailsAdd,
