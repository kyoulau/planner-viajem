          ...
          <div className='space-y-4'>
            <div className="h-16 px-4 bg-zinc-900 rounded-xl flex items-center shadow-shape gap-3">
                ...
                <div className='flex items-center gap-2 flex-1'>
                  ...
                  <input  disabled={isGuestOpen} className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1" placeholder="Para onde você vai" type="text" />
                </div>

                <div className='flex items-center gap-2 flex-1'>
                  <Calendar className=' size-5 text-zinc-400'/>
                  <input disabled={isGuestOpen}  className="bg-transparent text-lg placeholder-zinc-400 w-40 outline-none flex-1" placeholder="Quando?" type="text" />
                </div>
